...
public class Game 
{
    ...
    private Player currentPlayer;      	// לשמירת סימן השחקן הנוכחי
    private Model logicModel;
    private Move move;
    private boolean checkPress;
    

    public Game(ClientData player1, ClientData player2,int user1,int user2) throws IOException 
    {
        startGame(player1 ,player2 ,user1 ,user2);
    }
    
    public void startGame(ClientData playerOne, ClientData playerTwo, int user1, int user2) throws IOException 
    {
//        this.player1 = playerOne;
//        this.player2 = playerTwo;
        
        currentPlayer =  new NetworkPlayer(playerOne);
        currentPlayer.setPartner(playerTwo);
        ...
        new Thread(new Runnable()
        {
            ...
            {  
                ...
                if(currentPlayer.getPartner() instanceof NetworkPlayer)
                {
